...
def diplaySessionStatus(sessionSeller):
    sessionInfo = "\n-==Session Status==-\n\n--API Credentials--\n{}\n\n--Carrier Accounts Connected--\n{}".format(displayApiKeyStatus(sessionSeller), displayShipments(sessionSeller))
    ...
    for rates in sessionRates:
        ...
        for rate in sessionRates[rates]["returned_rates"]:
            if sessionRates[rates]["returned_rates"][rate]["package_type"] == None:
                rateEntry += "\nRate ID: {} - {}\n  Delivery Days: {} - Estimated Delivery Date: {} - Trackable: {}\n  Shipping Amount: {} {} - Insurance Amount: {} {} - Confirmation Amount: {} {} - Other Amount: {} {}\n".format(rate, sessionRates[rates]["returned_rates"][rate]["service_type"], sessionRates[rates]["returned_rates"][rate]["delivery_days"], sessionRates[rates]["returned_rates"][rate]["estimated_delivery_date"], sessionRates[rates]["returned_rates"][rate]["trackable"], sessionRates[rates]["returned_rates"][rate]["shipping_amount"]["amount"], sessionRates[rates]["returned_rates"][rate]["shipping_amount"]["currency"].upper(), sessionRates[rates]["returned_rates"][rate]["insurance_amount"]["amount"], sessionRates[rates]["returned_rates"][rate]["insurance_amount"]["currency"].upper(), sessionRates[rates]["returned_rates"][rate]["confirmation_amount"]["amount"], sessionRates[rates]["returned_rates"][rate]["confirmation_amount"]["currency"].upper(), sessionRates[rates]["returned_rates"][rate]["other_amount"]["amount"], sessionRates[rates]["returned_rates"][rate]["other_amount"]["currency"].upper())
            else:
                rateEntry += "\nRate ID: {} - {} [{}]\n  Delivery Days: {} - Estimated Delivery Date: {} - Trackable: {}\n  Shipping Amount: {} {} - Insurance Amount: {} {} - Confirmation Amount: {} {} - Other Amount: {} {}\n".format(rate, sessionRates[rates]["returned_rates"][rate]["service_type"], sessionRates[rates]["returned_rates"][rate]["package_type"], sessionRates[rates]["returned_rates"][rate]["delivery_days"], sessionRates[rates]["returned_rates"][rate]["estimated_delivery_date"], sessionRates[rates]["returned_rates"][rate]["trackable"], sessionRates[rates]["returned_rates"][rate]["shipping_amount"]["amount"], sessionRates[rates]["returned_rates"][rate]["shipping_amount"]["currency"].upper(), sessionRates[rates]["returned_rates"][rate]["insurance_amount"]["amount"], sessionRates[rates]["returned_rates"][rate]["insurance_amount"]["currency"].upper(), sessionRates[rates]["returned_rates"][rate]["confirmation_amount"]["amount"], sessionRates[rates]["returned_rates"][rate]["confirmation_amount"]["currency"].upper(), sessionRates[rates]["returned_rates"][rate]["other_amount"]["amount"], sessionRates[rates]["returned_rates"][rate]["other_amount"]["currency"].upper())
